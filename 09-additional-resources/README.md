...
## :motorway: Roadmaps for Generative AI
...
- [OpenAI Cookbook](https://github.com/openai/openai-cookbook) by OpenAI
- [Gemini Cookbook](https://github.com/GoogleCloudPlatform/generative-ai) by Google Cloud
- [Langchain Cookbook](https://python.langchain.com/v0.1/docs/cookbook/) by Langchain
