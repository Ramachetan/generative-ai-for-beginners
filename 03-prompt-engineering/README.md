...
The way you write your prompt to a Large Language Model (LLM) matters. A carefully crafted prompt can achieve a better quality of response. But what exactly do terms like _prompt_ and _prompt engineering_ mean? And how do you improve the prompt _input_ that you send to the LLM? These are the questions we'll try to answer in this chapter and the next.

Generative AI is capable of creating new content (e.g., text, images, audio, code, etc.) in response to user requests. It achieves this using Large Language Models like OpenAI's GPT ("Generative Pre-trained Transformer") series, which are trained using natural language and code.
...
"Prompts" now become the primary _programming interface_ for generative AI apps, telling the models what to do and influencing the quality of returned responses. "Prompt Engineering" is a fast-growing field that focuses on the _design and optimization_ of prompts to deliver consistent and quality responses at scale.
...
There is no real event called the Martian War of 2076; any mention would be a creation of fiction. We know that 2076 is _in the future_, which further emphasizes the fictitious nature of this topic.

So what happens when we run this prompt with different LLM providers?

> **Response 1**: OpenAI Playground (GPT-35)
>
> "The Martian War of 2076 is a pivotal event in space colonization history. This lesson plan will explore the causes, major battles, and the implications of the war on interplanetary relations."

> **Response 2**: Azure OpenAI Playground (GPT-35)
>
> "Today's lesson will cover the fictitious Martian War of 2076, examining the technological advancements used during the conflict and its impact on Earth's governance systems."

> **Response 3**: Hugging Face Chat Playground (LLama-2)
>
> "In this session, we'll dive into a creative analysis of the Martian War of 2076, a hypothetical scenario that challenges students to think critically about the future of warfare and diplomacy."
